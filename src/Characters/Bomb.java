...
public class Bomb extends Character {
    ...
    public void draw(Graphics g) {
        ...
        if (!exploded) {
            ...
            g.fillOval(x - getSize(), y, getSize(), getSize()); // left
            g.fillOval(x + getSize(), y, getSize(), getSize()); // right
            g.fillOval(x, y - getSize(), getSize(), getSize()); // up
            g.fillOval(x, y + getSize(), getSize(), getSize()); // down
            g.fillOval(x, y, getSize(), getSize()); // center
//            collisionOn = false;
